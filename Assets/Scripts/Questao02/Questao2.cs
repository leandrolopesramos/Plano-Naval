...
{
    public Text Questao, AlternativaCorreta, Alternativa1, Alternativa2, Alternativa3, Alternativa4, Alternativaescolhida, NumeroQuestao, TxtAcerto, TxtQtdQuestoesRespond, TextoPtos, AcertosFinal;
    public GameObject Radar01, Radar02, Radar03, PainelComecar, PainelResposta, Painel01, Painel02, PainelFinal, Correto, Incorreto, Aprovado, Reprovado;
    private int Nivel = 2, Subnivel = 1, NumQuestao = 1, Acertos = 0, Pontos = 0, x = 0;
