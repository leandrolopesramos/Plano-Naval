...
public class Final06 : MonoBehaviour
{
    public Button BtnContinuar, SetaEsq, SetaDir;

    public GameObject Painel01, Quadrinho01, Quadrinho02, Quadrinho03, Quadrinho04, Quadrinho05, Quadrinho06, Quadrinho07, Quadrinho08, Quadrinho09, 
                      Quadrinho10, Quadrinho11, Quadrinho12, Quadrinho13, Quadrinho14, Quadrinho15, Quadrinho16, Quadrinho17, Quadrinho18;
    ...
    public void SetaDireita()
    {
        ...
        if (x == 15)
        {
            ...
            Quadrinho15.SetActive(true);
        }

        if (x == 16)
        {
            Quadrinho15.SetActive(false);
            Quadrinho16.SetActive(true);
        }

        if (x == 17)
        {
            Quadrinho16.SetActive(false);
            Quadrinho17.SetActive(true);
        }

        if (x == 18)
        {
            Quadrinho17.SetActive(false);
            Quadrinho18.SetActive(true);
